    ...
    public abstract class IValue : IToken, IEquatable<IValue>
    {
        ...
        public override string ToString()
        {
            ...
            switch(GetValueType())
            {
                ...
                case  'b':
                    ss.Append(GetBool() ? "true" : "false"); break;
                case  'c':
                    ss.AppendFormat("'{0}'", GetChar()); break;
                case  's':
                    ss.AppendFormat("\"{0}\"", GetString()); break;
                case  'v':
        ...
        public static implicit operator IValue(long i) {
            return new Value(i);
        }
        public static implicit operator IValue(bool i) {
            return new Value(i);
        }
        public static implicit operator IValue(double i) {
            return new Value(i);
        }
        public static implicit operator IValue(string i){
            return new Value(i);
        }
        public static implicit operator IValue(Complex i){
            return new Value(i);
        }
        public static implicit operator IValue(Matrix i){
            return new Value(i);
        }

        
        public static explicit operator int(IValue v){
            return (int)v.GetInteger();
        }
        public static explicit operator BigInteger(IValue v){
            return v.GetInteger();
        }
        public static explicit operator double(IValue v){
            return v.GetFloat();
        }
        public static explicit operator string(IValue v){
            return v.GetString();
        }
        public static explicit operator bool(IValue v){
            return v.GetBool();
        }
        public static explicit operator Complex(IValue v){
            return v.GetComplex();
        }
        public static explicit operator Matrix(IValue v){
            return v.GetArray();
        }
        
        public static explicit operator char(IValue v){
            return v.GetChar();
        }
        //---------------------------------------------------------------------------
